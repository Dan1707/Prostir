  ...
  <section class="w-full bg-[linear-gradient(92deg,_#5dff4f_0%,_#53aa56_100%)]">
    ...
    >
      ...
      >
        ...
        <p
          class="font-normal text-[1.38rem] leading-[127%] tracking-[0.02em] text-secondary-primary font-subTitle max-w-[499px] mt-[10px]"
        >
...
.hero-img::before {
  ...
  width: 463px;
  height: 365px;
  background-image: url("../../../src/assets/img/hero-img-bg.png");
